...
## Training VL-BART-Cntl
For training use the vlbart.sh in /gpfs_volume/k.basioti/trainingExec/

## Evaluation VL-BART-Cntl
```bash
python -m torch.distributed.launch \
    src/cntlcaption_evaluate.py  \
        --distributed --multiGPU --fp16 \
        --num_workers 80 \
        --load model_filepath/EpochX \
        --cntl_dataset_dir /group-volume/IVU/flickr30k/flickr30kCaptions_Original/ \
        ...
        --batch_size 80 \
        --gen_max_length 50\
        --results_csv model_filepath/csvname
```
