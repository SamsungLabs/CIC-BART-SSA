        ...
        with torch.no_grad():
            ...
            for _, batch in enumerate(self.val_loader):
                ...
                for idx in range(len(generated_sentences)):
                    ...
                    try:
                        score = noun_iou.score_modified(cntl_names[idx], generated_sentences[idx])
                        t_iou_score, t_gtmi_percent, t_prmi_percent, t_r_iou_score, t_r_gtmi_percent, t_r_prmi_percent, seq_gt, seq_pred = score
